            ...
            <div class="header-body text-center mb-5">
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-6">
                        <h1 class="text-primary"><i class="ni ni-curved-next"></i> Create New Account to OPTIAUTO!</h1>
                ...
                <div class="card bg-secondary shadow-sm border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small><i class="ni ni-badge"></i> Please fill up the form below!</small>
                        </div>
                        <form role="form" method="POST" action="{{ route('users.register') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="Password..." name="password_confirmation"
                                        type="password" required>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
